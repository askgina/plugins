...
8. Update plugin-core, sync, conformance, pack, verifier, and evaluator tests at their existing boundaries. Update `ai_docs/architecture.md` to distinguish root OpenAI source, non-OpenAI overlays, generated targets, and ignored artifacts.
