# Client logos in the connection guide

The linked marks in `docs/connect/index.mdx` are served locally from `docs/images/clients/` and identify each client's setup guide. Assets were retrieved September 18, 2026 and are unmodified. Brand marks remain the property of their respective owners.

- ChatGPT: OpenAI mark already vendored in `apps/evals/public/images/model-logos/openai.svg` from [LobeHub Icons](https://github.com/lobehub/lobe-icons/blob/master/packages/static-svg/icons/openai.svg).
...
- Grok Bot: the PNG logo supplied by the product owner on September 18, 2026, copied without modifications.
