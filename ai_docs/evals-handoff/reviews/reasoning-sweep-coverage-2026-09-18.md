...
- The previous table selected the newest setting even when it lacked complete grading. Astra max therefore appeared unranked beneath fully graded Gemini. The corrected default selects by complete grading and date within the newest campaign, never by highest score. Every setting remains selectable, and per-model counts disclose incomplete settings.
